    ...
    <>
      ...
      <AuthLayout bottomLinks={<BottomLink />}>
        <div className="auth-logo mx-auto">
          <Link to="/" className="logo logo-dark text-center">
            <span className="logo-lg">
              ...
              {/* <h2 className="text-dark fw-bold">Welcome to the dashboard</h2> */}
            </span>
          </Link>

          <Link to="/" className="logo logo-light text-center">
            <span className="logo-lg">
              <img src={logoRby} alt="" height="24" />
        ...
        <p className="text-muted mt-1 mb-4">
          ...
          {/* enter you email address and password from */}
        </p>
        ...
        <VerticalForm<UserData>
          ...
          defaultValues={{ email: "admin@rubytech.com", password: "test" }}
        ...
        >
          <FormInput
            ...
            placeholder={t("hello@rubytec1233.com")}
            containerClass={"mb-3"}
          />
          <FormInput
            type="password"
