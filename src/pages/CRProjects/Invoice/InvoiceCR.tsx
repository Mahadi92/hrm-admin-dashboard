...
import logoRuby from '../../../assets/images/logo_ruby.png'
// import logoRby from "../../assets/images/logo_ruby.png";
import PageTitle from "../../../components/PageTitle";
import { invoiceData } from "../../other/data";
                    ...
                    <div className="auth-logo">
                      <Link to="/" className="logo logo-dark text-center">
                        <span className="logo-lg">
                          <img src={logoRuby} alt="" height="35" />
                        </span>
                      </Link>
                ...
                <div className="mt-5 mb-1">
                  <div className="text-end d-print-none">
                    <Link
                      ...
                      className="btn btn-success me-1 fw-bold"
                    >
                      <i className="uil uil-print me-1"></i> Print
                    </Link>
                    <Link to="#" className="btn btn-info fw-bold">
                      Submit
                    </Link>
                  </div>
                </div>
