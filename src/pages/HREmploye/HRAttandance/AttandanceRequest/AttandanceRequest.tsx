      ...
      <div className='mt-2 mb-4 p-3'>
        <div className="d-flex">
          <Button type="submit" className="lgnbtn fw-bold align-items-center" onClick={handleShow}>
            <FeatherIcon icon="plus" className="me-1" style={{ width: '22px' }} /> <span className="fs-5">Add Attendance</span>
          </Button>
        </div>
        <div className="mt-4">
                      ...
                      filteredData.map((item: {
                        ...
                        <tbody key={index}>
                          <tr>
                            ...
                            <td className="text-center d-flex justify-content-center align-items-center w-100">
                              <div className="d-flex">
...
export default AttandanceRequest
