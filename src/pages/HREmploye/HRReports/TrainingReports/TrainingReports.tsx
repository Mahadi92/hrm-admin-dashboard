            ...
            <Table >
              <thead>
                <tr style={{ backgroundColor: "#F3F4F7", fontWeight: 'bold' }}>
                  ...
                  <th className="fw-bolder border-end text-center text-muted">Training Type</th>
                  <th className="fw-bolder text-center text-muted">Trainer</th>
                  <th className="fw-bolder text-center text-muted">Training Duration</th>
                  <th className="fw-bolder text-center text-muted">Cost</th>
