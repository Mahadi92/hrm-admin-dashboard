            ...
            <Row>
              <Col md={6}>
                <Form.Group className="mb-2 mt-2 w-100" controlId="formBasicPassword">
                  <Form.Label>
                    <FeatherIcon icon="star" className="me-1" style={{ width: '10px', color: 'red', }} /> Select Task
                  </Form.Label>
            ...
            <Table >
              <thead>
                <tr style={{ backgroundColor: "#F3F4F7", fontWeight: 'bold' }}>
                  ...
                  <th className="fw-bolder text-center text-muted">Task Summary</th>
                  ...
                  <th className="fw-bolder text-center text-muted">Task Progress</th>
                  <th className="fw-bolder text-center text-muted">Added By</th>
