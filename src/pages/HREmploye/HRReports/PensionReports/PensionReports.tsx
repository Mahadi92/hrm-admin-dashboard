            ...
            <Table >
              <thead>
                <tr style={{ backgroundColor: "#F3F4F7", fontWeight: 'bold' }}>
                  ...
                  <th className="fw-bolder border-end text-muted">Employee Name</th>
                  <th className="fw-bolder text-center text-muted">Month-Year</th>
                  <th className="fw-bolder border-end text-center text-muted">Payment Type</th>
                  <th className="fw-bolder text-center text-muted">Basic Salary</th>
                  <th className="fw-bolder text-center text-muted">Pension Type</th>
                  <th className="fw-bolder text-center text-muted">Pension Amount</th>
                  <th className="fw-bolder text-center text-muted">Remaining Balance</th>
              ...
              <tbody>
                <tr>
                  ...
                  <td>Ashok</td>
                  <td>May-12</td>
                  <td className="text-center">Mobile Banking</td>
                  <td className="text-center">12000</td>
                  <td className="text-center">Regular</td>
                  <td className="text-center">1400000</td>
                  <td className="text-center">122222</td>
