            ...
            <Row>
              <Col md={4}>
                <Form.Group className="mb-2 mt-3 w-100" controlId="formBasicPassword">
                  <Form.Label>
                    <FeatherIcon icon="star" className="me-1" style={{ width: '10px', color: 'red', }} /> Category
                  </Form.Label>
            ...
            <Table >
              <thead>
                <tr style={{ backgroundColor: "#F3F4F7", fontWeight: 'bold' }}>
                  ...
                  <th className="fw-bolder text-center text-muted">Category</th>
                  <th className="fw-bolder border-end text-center text-muted">Payee</th>
                  <th className="fw-bolder text-center text-muted">($)Amount</th>
                  <th className="fw-bolder text-center text-muted">Reference No</th>
