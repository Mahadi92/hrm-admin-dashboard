                    ...
                    <div className="w-100  bg-white">
                        ...
                        <div className="p-2">
                            <div className="d-flex justify-content-between align-items-center ">
                                <h4 className="fw-bold text-dark">Add New Award</h4>
                                <Link to="/apps/hremploye/corehr/Award" style={{ textDecoration: "none" }}>
                            ...
                            <Row>
                                ...
                                <Col md={3}>
                                    <Form.Group className="mb-2 mt-2 w-100" controlId="formBasicPassword">
                                        <Form.Label>
                                            <FeatherIcon icon="star" className="me-1" style={{ width: '10px', color: 'red', }} /> Award Type
                                        </Form.Label>
                                        <div className="d-flex">
                                            <Form.Select className="fw-bold">
                                                <option>Nothing Selected</option>
                                                <option>Best Emp</option>
                                            </Form.Select>
                                        </div>
                                    </Form.Group>
                                </Col>
                            ...
                            <Row>
                                <Col md={3}>
                                    <Form.Group className="mb-2" controlId="formBasicEmail">
                                        <Form.Label className="text-secondary">
                                            <FeatherIcon icon="star" className="me-1" style={{ width: '10px', }} /> Gift
                                        </Form.Label>
                                ...
                                <Col md={3}>
                                    <Form.Group className="mb-2" controlId="formBasicEmail">
                                        <Form.Label className="text-secondary">
                                            <FeatherIcon icon="star" className="me-1" style={{ width: '10px', }} /> Cash
                                        </Form.Label>
                                        <Form.Control type="text" />
                                    </Form.Group>
                                </Col>
                                <Col md={3}>
                                    <Form.Group className="mb-2" controlId="formBasicEmail">
                                        <Form.Label>
                                            <FeatherIcon icon="star" className="me-1" style={{ width: '10px', color: 'red', }} /> Award Date
                                        </Form.Label>
                            ...
                            <Col md={12}>
                                <Form.Group className="mb-2" controlId="formBasicEmail">
                                    <Form.Label>
                                        <FeatherIcon icon="star" className="me-1" style={{ width: '10px', color: 'red', }} /> Award Information
                                    </Form.Label>
