...
const NewGenarateSalarySheetRoll = () => {
    return (
                ...
                Generate Salary Sheet
                    ...
                    <div className="p-2">
                        ...
                        <div className="d-flex justify-content-between align-items-center ">
                            <h4 className="fw-bold text-dark">Generate Salary Sheet</h4>
                            <Link to="/apps/hremploye/payroll/salarysheet" style={{ textDecoration: "none" }}>
...
export default NewGenarateSalarySheetRoll        