                    ...
                    <div className="w-100  bg-white">
                        ...
                        <div className="p-2">
                            <div className="d-flex justify-content-between align-items-center ">
                                <h4 className="fw-bold text-dark">Add New Hourly Pay Grade</h4>
                                <Link to="/apps/hremploye/payroll/hourlypaygrade" style={{ textDecoration: "none" }}>
                            ...
                            <Row>
                                <Col md={6}>
                                    <Form.Group className="mb-2 mt-2 w-100" controlId="formBasicPassword">
                                        <Form.Label>
                                            <FeatherIcon icon="star" className="me-1" style={{ width: '10px', color: 'red', }} /> Pay Grade Name
                                        </Form.Label>
...
export default NewHourlyPayGradeRoll       