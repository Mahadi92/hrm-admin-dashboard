      ...
      <div className='mt-2 p-3 mb-4'>
        <div className="kbbtnbox d-flex justify-content-between align-items-center">
          <div className="d-flex">
            <Link to="/apps/hremploye/payroll/hourlypaygrade/addnew" style={{ textDecoration: "none" }}>
              <Button type="submit" variant="success" className="fw-bold align-items-center">
                <FeatherIcon icon="plus" className="me-1" style={{ width: '22px' }} /> <span className="fs-5">Add Hourly Pay</span>
              </Button>
            </Link>
          </div>
        </div>
                  ...
                  <Table bordered>
                    <thead>
                      <tr style={{ backgroundColor: "#F3F4F7", fontWeight: 'bold' }}>
                        ...
                        <th className="fw-bolder border-end text-secondary text-center">Hourly Grade</th>
                        <th className="fw-bolder text-center text-secondary">Hourly Rate</th>
                    ...
                    <tbody>
                      <tr>
                        <td>1</td>
                        <td className='text-center'>H-A</td>
...
export default HourlyPayGradeRoll
