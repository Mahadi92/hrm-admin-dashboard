                    ...
                    <div className="w-100  bg-white">
                        ...
                        <div className="p-2">
                            <div className="d-flex justify-content-between align-items-center ">
                                <h4 className="fw-bold text-dark">Add New Deduction</h4>
                                <Link to="/apps/hremploye/payroll/Deduction" style={{ textDecoration: "none" }}>
...
export default NewDeductionRoll     