      ...
      <div className='mt-4 p-3 mb-4'>
        <div className="kbbtnbox d-flex justify-content-between align-items-center">
          <div className="d-flex">
            <Link to="/apps/hremploye/payroll/Deduction/addnew" style={{ textDecoration: "none" }}>
              <Button type="submit" variant="success" className="fw-bold align-items-center">
                <FeatherIcon icon="plus" className="me-1" style={{ width: '22px' }} /> <span className="fs-5">Add Deduction</span>
              </Button>
            </Link>
          </div>
        </div>
                ...
                <Table bordered>
                  <thead>
                    <tr style={{ backgroundColor: "#F3F4F7", fontWeight: 'bold' }}>
                      ...
                      <th className="fw-bolder border-end text-secondary text-center">Deduction Name</th>
                      <th className="fw-bolder text-center text-secondary">Deduction Type</th>
...
export default DeductionPayRoll
