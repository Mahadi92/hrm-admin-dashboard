      ...
      <div className='mt-2 p-3 mb-4'>
        <div className="kbbtnbox d-flex justify-content-between align-items-center">
          <div className="d-flex">
            <Link to="/apps/hremploye/payroll/Allowance/addnew" style={{ textDecoration: "none" }}>
              <Button type="submit" variant="success" className="fw-bold align-items-center">
                <FeatherIcon icon="plus" className="me-1" style={{ width: '22px' }} /> <span className="fs-5">Add Allowance</span>
              </Button>
            </Link>
          </div>
        </div>
                ...
                <Table bordered>
                  <thead>
                    <tr style={{ backgroundColor: "#F3F4F7", fontWeight: 'bold' }}>
                      ...
                      <th className="fw-bolder border-end text-secondary text-center">Allowance Name</th>
                      <th className="fw-bolder text-center text-secondary">Allowance Type</th>
                      <th className="fw-bolder text-center text-secondary">Percentage of Basic</th>
                      <th className="fw-bolder text-center text-secondary">Limit Per Month</th>
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className='text-center'>House Rent</td>
...
export default AllowancePayRoll
