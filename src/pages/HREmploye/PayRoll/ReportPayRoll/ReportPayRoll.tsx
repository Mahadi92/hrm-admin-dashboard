            ...
            <Table >
              <thead>
                <tr style={{ backgroundColor: "#F3F4F7", fontWeight: 'bold' }}>
                  ...
                  <th className="fw-bolder border-end text-muted">Festival Number</th>
                  <th className="fw-bolder text-center text-muted">Percentage of Bonus</th>
                  <th className="fw-bolder border-end text-center text-muted">Employee</th>
                  <th className="fw-bolder text-center text-muted">Salary Month</th>
                  <th className="fw-bolder text-center text-muted">Salary Details</th>
              ...
              <tbody>
                <tr>
                  ...
                  <td className="text-center">Asif</td>
