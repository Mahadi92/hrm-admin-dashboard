          ...
          <div className="w-100  bg-white">
            ...
            <div className="p-2">
              <div className="d-flex justify-content-between align-items-center ">
                <h4 className="fw-bold text-dark">Add Travel</h4>
              ...
              <Row>
                ...
                <Col md={4}>
                  <Form.Group className="mb-2 mt-2 w-100" controlId="formBasicPassword">
                    <Form.Label>
                      <FeatherIcon icon="star" className="me-1" style={{ width: '10px', color: 'red', }} /> Arragement Type
                    </Form.Label>
                    <div className="d-flex">
                      <Form.Select className="fw-bold">
                        <option>Nothing Selected</option>
                  ...
                  <Form.Group className="mb-2 mt-2 w-100" controlId="formBasicPassword" >
                    ...
                    <div className="d-flex">
                      <Form.Select className="fw-bold">
                        ...
                        <option>Firs Level Approval</option>
                        <option>Rejected</option>
                        <option>Approbal</option>
                      </Form.Select>
                    </div>
                  </Form.Group>
                </Col>
