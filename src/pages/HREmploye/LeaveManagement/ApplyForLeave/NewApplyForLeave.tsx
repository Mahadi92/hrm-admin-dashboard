          ...
          <div className="w-100  bg-white">
            ...
            <div className="p-2">
              <div className="d-flex justify-content-between align-items-center ">
                ...
                <Link to="/apps/hremploye/applyleave_management" style={{ textDecoration: "none" }}>
              ...
              <Row>
                <Col md={4}>
                  <Form.Group className="mb-2" controlId="formBasicEmail">
                    <Form.Label>
                      <FeatherIcon icon="star" className="me-1" style={{ width: '10px', color: 'red', }} /> Current Balance
                    </Form.Label>
...
export default NewApplyForLeave    