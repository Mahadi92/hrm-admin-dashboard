...
const LeaveStatus = () => {
  ...
  const [Reason_Note, setReason_Note] = useState("");

  // here - get all data from user input fields and send to backend...
  const handleAssignLeave: React.MouseEventHandler<HTMLButtonElement> = async (
    event
  ) => {
    ...
    // console.log("Leave_Duration", Leave_Duration);
    // console.log("End_Date", End_Date);
    // console.log("Reason_Note", Reason_Note);

    const url = "https://pubapi.rubytech.xyz/leave/leave/";
        ...
        <div className="d-flex">
          ...
          >
            <FeatherIcon
              ...
              style={{ width: "22px" }}
            />{" "}
            <span className="fs-5">Assign Leave</span>
          </Button>
        </div>
                  ...
                  <Col md={12}>
                    ...
                    >
                      ...
                      <Form.Control
                        as="textarea"
                        className=""
                        onChange={(e) => setReason_Note(e.target.value)}
                      />
                    </Form.Group>
                  </Col>
                </Modal.Body>
              ...
              <Row className="gy-2 w-100">
                <Col md={3}>
                  <Button
                    type="submit"
                    variant="light"
                    className="fw-bold align-items-center border-end border-5 text-dark fw-bold"
                  >
                ...
                <Col md={3}>
                  ...
                  >
                    ...
                    <span className="fw-bold text-warning">
                      On Leave <strong>(Single Day)</strong>{" "}
                    </span>
                  </Button>
                </Col>
                <Col md={3}>
                  ...
                  >
                    ...
                    <span className="fw-bold text-secondary">
                      On Leave <strong>(Multi day)</strong>
                    </span>
                  </Button>
                </Col>
              </Row>
              ...
              <div className="staffSelec d-flex justify-content-between">
                ...
                <div className="staffSearch d-flex justify-content-start w-100">
                  <div className="ms-auto d-flex justify-content-start">
                    <Button
                      variant="light d-flex justify-content-center align-items-center"
                      style={{ height: "30px" }}
                    >
                      ...
                      <tr>
                        ...
                        <td>
                          <div className="d-flex">
                            ...
                            <Button
                              variant="danger d-flex justify-content-center align-items-center ms-2"
                              style={{ height: "30px" }}
                            >
