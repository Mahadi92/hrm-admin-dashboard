      ...
      <div className='mt-2 mb-4 p-3'>
        <div className="kbbtnbox d-flex justify-content-between align-items-center">
          <div className="d-flex">
            <Link to="/apps/hremploye/performance/goaltracking/addnew" style={{ textDecoration: "none" }}>
              <Button type="submit" variant="success" className="fw-bold align-items-center">
                <FeatherIcon icon="plus" className="me-1" style={{ width: '22px' }} /> <span className="fs-5">Add New Track</span>
              </Button>
            </Link>
            ...
            <Table >
              <thead>
                <tr style={{ backgroundColor: "#F3F4F7", fontWeight: 'bold' }}>
                  ...
                  <th className="fw-bolder border-end text-muted">Goal Type</th>
                  <th className="fw-bolder border-end text-muted">Company</th>
                  <th className="fw-bolder border-end text-muted">Target Achievement</th>
                  <th className="fw-bolder border-end text-muted">Start Date</th>
                  <th className="fw-bolder border-end text-muted">End Date</th>
                  <th className="fw-bolder border-end text-muted">Progress</th>
...
export default GoalTrackingPer   