      ...
      <div className='mt-2 p-3 mb-4'>
        <div className="kbbtnbox d-flex justify-content-between align-items-center">
          <div className="d-flex">
            <Link to="/apps/hremploye/Promotions/addnew" style={{ textDecoration: "none" }}>
              <Button type="submit" variant="success" className="fw-bold align-items-center">
                <FeatherIcon icon="plus" className="me-1" style={{ width: '22px' }} /> <span className="fs-5">Add Promotions</span>
              </Button>
            </Link>
          </div>
        </div>
                  ...
                  <Table >
                    <thead>
                      <tr style={{ backgroundColor: "#F3F4F7", fontWeight: 'bold' }}>
                        ...
                        <th className="fw-bolder text-center text-secondary">Subject</th>
                        <th className="fw-bolder text-center text-secondary">Promotions Date</th>
                        <th className="fw-bolder text-center text-secondary">Promoted Department</th>
                        <th className="fw-bolder text-center text-secondary">Promoted Designation</th>
                        <th className="fw-bolder text-center text-secondary">Promoted Pay Grade</th>
                        <th className="fw-bolder text-center text-secondary">Promoted Salary</th>
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td className='text-center'>12/8/23</td>
                        <td className='text-center'>Design</td>
                        <td className='text-center'>Ux Designer</td>
                        <td className='text-center'>12th</td>
                        <td className='text-center'>20003</td>
