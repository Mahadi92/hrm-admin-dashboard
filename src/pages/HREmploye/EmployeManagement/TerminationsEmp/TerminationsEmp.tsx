      ...
      <div className='mt-2 p-3 mb-4'>
        <div className="kbbtnbox d-flex justify-content-between align-items-center">
          <div className="d-flex">
            <Link to="/apps/hremploye/Termination/addnew" style={{ textDecoration: "none" }}>
              <Button type="submit" variant="success" className="fw-bold align-items-center">
                <FeatherIcon icon="plus" className="me-1" style={{ width: '22px' }} /> <span className="fs-5">Add Terminations</span>
              </Button>
            </Link>
          </div>
        </div>
                ...
                <Table >
                  <thead>
                    <tr style={{ backgroundColor: "#F3F4F7", fontWeight: 'bold' }}>
                      ...
                      <th className="fw-bolder text-center text-secondary">Termination Type</th>
                      <th className="fw-bolder text-center text-secondary">Termination Date</th>
                      <th className="fw-bolder text-center text-secondary">Terminated By</th>
                      <th className="fw-bolder text-center text-secondary">Status</th>
                      <th className="fw-bolder text-center text-secondary">Notice Date</th>
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className='text-center'>Rule Violation</td>
...
export default TerminationsEmp
