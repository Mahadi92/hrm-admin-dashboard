      ...
      <div className='mt-2 p-3 mb-4'>
        <div className="kbbtnbox d-flex justify-content-between align-items-center">
          <div className="d-flex">
            <Link to="/apps/hremploye/Warning/addnew" style={{ textDecoration: "none" }}>
              <Button type="submit" variant="success" className="fw-bold align-items-center">
                <FeatherIcon icon="plus" className="me-1" style={{ width: '22px' }} /> <span className="fs-5">Add Warning</span>
              </Button>
            </Link>
          </div>
        </div>
                  ...
                  <Table >
                    <thead>
                      <tr style={{ backgroundColor: "#F3F4F7", fontWeight: 'bold' }}>
                        ...
                        <th className="fw-bolder text-center text-secondary">Warning Date</th>
                        <th className="fw-bolder text-center text-secondary">Subject</th>
                        <th className="fw-bolder text-center text-secondary">Warning Type</th>
                        <th className="fw-bolder text-center text-secondary">Warning By</th>
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td className='text-center'>Rule Violations</td>
                        ...
                        <td className="text-center d-flex justify-content-center align-items-center">
                          <div className="d-flex">
                            <Button variant="primary text-white d-flex justify-content-center align-items-center" style={{ height: '30px' }}>
