      ...
      <div className='mt-4 p-3 mb-4'>
        <div className="kbbtnbox d-flex justify-content-between align-items-center">
          <div className="d-flex">
            <Link to="/apps/hremploye/Branch/addnew" style={{ textDecoration: "none" }}>
              <Button type="submit" variant="success" className="fw-bold align-items-center">
                <FeatherIcon icon="plus" className="me-1" style={{ width: '22px' }} /> <span className="fs-5">Add Branch</span>
              </Button>
            </Link>
          </div>
        </div>
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className="text-center d-flex justify-content-center align-items-center">
                        <div className="d-flex">
                          <Button variant="primary d-flex justify-content-center align-items-center" style={{ height: '30px' }}>
